 ...
 * host's users a one-click entry into the two main Zoron workflows without
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "1. Call zoron_parse_mandate to turn the description into a structured mandate. Show me the criteria it extracted and flag anything it missed or guessed.",
              "2. Call zoron_discover with the returned mandateId to build the shortlist.",
              shortlistSize
                ? `3. If fewer than ${shortlistSize} companies come back, use zoron_expand_shortlist to top it up.`
                : "3. If the shortlist looks thin, use zoron_expand_shortlist to add more.",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "1. Call zoron_lookup_company to resolve it and confirm you have the right entity — check the domain matches before going further.",
              question
                ? `2. Call zoron_deep_dive on that domain, passing userQuestion: "${question}".`
                : "2. Call zoron_deep_dive on that domain for the full profile.",
